...
extern void top_idct(dct_data_t in_block[N], dct_data_t out_block[N]);
extern void wang_idct(short int *inp_block, short int *out_block);
extern void shift_dct2d(int (*data)[8], int height, int width);
extern void shift_idct2d(int(*data)[8], int height, int width);
